...
```bash
claude mcp add garmin -e GARMIN_EMAIL=you@email.com -e GARMIN_PASSWORD='yourpass'  -- npx -y @fernandocov/garmin-connect-mcp
```
...
```json
{
  "mcpServers": {
    "garmin": {
      "command": "npx",
      "args": ["-y", "@fernandocov/garmin-connect-mcp"],
      "env": {
...
```bash
GARMIN_EMAIL=you@email.com GARMIN_PASSWORD=yourpass npx -y @fernandocov/garmin-connect-mcp
```
...
```bash
GARMIN_EMAIL='you@email.com' GARMIN_PASSWORD='yourpass' npx -y @fernandocov/garmin-connect-mcp setup
```
